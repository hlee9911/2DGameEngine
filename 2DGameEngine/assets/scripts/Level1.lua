-- load different tilemap image depending on the current system time
...
Level = {
    ...
    assets = {
        ...
        { type = "font"   , id = "charriot-font",               file = "./assets/fonts/charriot.ttf", font_size = 8 },
        { type = "font"   , id = "pico8-font-8",                file = "./assets/fonts/charriot.ttf", font_size = 10 },
        { type = "font"   , id = "pico8-font-10",               file = "./assets/fonts/charriot.ttf", font_size = 18 }
    },
    ...
    entities = {
        [0] =
        {
            ...
            components = {
                ...
                projectile_emitter = {
                    projectile_velocity = { x = 250, y = 250 },
                ...
                keyboard_controller = {
                    up_velocity = { x = 0, y = -120 },
                    right_velocity = { x = 120, y = 0 },
                    down_velocity = { x = 0, y = 120 },
                    left_velocity = { x = -120, y = 0 }
                },
                camera_follow = {
                    follow = true
                }
        ...
        },
        {
            ...
            components = {
                ...
                on_update_script = {
                    [0] =
                    function(entity, delta_time, ellapsed_time)
                        -- print("Executing F-22 Raptor Lua script!")
